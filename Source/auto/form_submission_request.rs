...
pub trait FormSubmissionRequestExt: IsA<FormSubmissionRequest> + sealed::Sealed + 'static {
	...
	// fn text_fields(&self) -> /*Unknown conversion*//*Unimplemented*/HashTable
	// TypeId { ns_id: 0, id: 25 }/TypeId { ns_id: 0, id: 25 } {    unsafe {
	// TODO: call ffi:webkit_form_submission_request_get_text_fields() }
	//}
