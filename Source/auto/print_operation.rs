...
impl PrintOperation {
	...
	/// [`PrintOperation`] objects.
	///
	/// This method returns an instance of
	/// [`PrintOperationBuilder`](crate::builders::PrintOperationBuilder) which
	/// can be used to create [`PrintOperation`] objects.
	pub fn builder() -> PrintOperationBuilder { PrintOperationBuilder::new() }
}
