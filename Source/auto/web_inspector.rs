...
pub trait WebInspectorExt: IsA<WebInspector> + sealed::Sealed + 'static {
	...
	fn is_attached(&self) -> bool {
		unsafe { from_glib(ffi::webkit_web_inspector_is_attached(self.as_ref().to_glib_none().0)) }
	}
	...
	fn connect_attach<F:Fn(&Self) -> bool + 'static>(&self, f:F) -> SignalHandlerId {
		unsafe extern fn attach_trampoline<P:IsA<WebInspector>, F:Fn(&P) -> bool + 'static>(
	...
	fn connect_bring_to_front<F:Fn(&Self) -> bool + 'static>(&self, f:F) -> SignalHandlerId {
		unsafe extern fn bring_to_front_trampoline<
			P:IsA<WebInspector>,
			F:Fn(&P) -> bool + 'static,
		>(
			this:*mut ffi::WebKitWebInspector,
	...
	fn connect_closed<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		unsafe extern fn closed_trampoline<P:IsA<WebInspector>, F:Fn(&P) + 'static>(
			this:*mut ffi::WebKitWebInspector,
			f:glib::ffi::gpointer,
		) {
			let f:&F = &*(f as *const F);
	...
	fn connect_detach<F:Fn(&Self) -> bool + 'static>(&self, f:F) -> SignalHandlerId {
		unsafe extern fn detach_trampoline<P:IsA<WebInspector>, F:Fn(&P) -> bool + 'static>(
			this:*mut ffi::WebKitWebInspector,
			f:glib::ffi::gpointer,
		) -> glib::ffi::gboolean {
			let f:&F = &*(f as *const F);
	...
	fn connect_open_window<F:Fn(&Self) -> bool + 'static>(&self, f:F) -> SignalHandlerId {
		unsafe extern fn open_window_trampoline<P:IsA<WebInspector>, F:Fn(&P) -> bool + 'static>(
			this:*mut ffi::WebKitWebInspector,
			f:glib::ffi::gpointer,
		) -> glib::ffi::gboolean {
			let f:&F = &*(f as *const F);
	...
	fn connect_attached_height_notify<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		unsafe extern fn notify_attached_height_trampoline<
			P:IsA<WebInspector>,
			F:Fn(&P) + 'static,
		>(
			this:*mut ffi::WebKitWebInspector,
	...
	fn connect_can_attach_notify<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		unsafe extern fn notify_can_attach_trampoline<P:IsA<WebInspector>, F:Fn(&P) + 'static>(
			this:*mut ffi::WebKitWebInspector,
			_param_spec:glib::ffi::gpointer,
			f:glib::ffi::gpointer,
		) {
	...
	fn connect_inspected_uri_notify<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		unsafe extern fn notify_inspected_uri_trampoline<
			P:IsA<WebInspector>,
			F:Fn(&P) + 'static,
		>(
			this:*mut ffi::WebKitWebInspector,
