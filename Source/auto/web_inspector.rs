...
pub trait WebInspectorExt:
	IsA<WebInspector> + sealed::Sealed + 'static {
	...
	fn attached_height(&self) -> u32 {
		unsafe {
			ffi::webkit_web_inspector_get_attached_height(
	...
	fn connect_attach<F:Fn(&Self) -> bool + 'static>(
		...
		unsafe extern fn attach_trampoline<
			P:IsA<WebInspector>,
			F:Fn(&P) -> bool + 'static,
		>(
	...
	fn connect_detach<F:Fn(&Self) -> bool + 'static>(
		...
		unsafe extern fn detach_trampoline<
			P:IsA<WebInspector>,
			F:Fn(&P) -> bool + 'static,
		>(
			this:*mut ffi::WebKitWebInspector,
	...
	fn connect_can_attach_notify<F:Fn(&Self) + 'static>(
		...
		unsafe extern fn notify_can_attach_trampoline<
			P:IsA<WebInspector>,
			F:Fn(&P) + 'static,
		>(
			this:*mut ffi::WebKitWebInspector,
