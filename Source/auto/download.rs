...
pub trait DownloadExt: IsA<Download> + sealed::Sealed + 'static {
	...
	fn request(&self) -> Option<URIRequest> {
		unsafe { from_glib_none(ffi::webkit_download_get_request(self.as_ref().to_glib_none().0)) }
	}

	#[doc(alias = "webkit_download_get_response")]
	#[doc(alias = "get_response")]
	fn response(&self) -> Option<URIResponse> {
		unsafe { from_glib_none(ffi::webkit_download_get_response(self.as_ref().to_glib_none().0)) }
	}

	#[doc(alias = "webkit_download_get_web_view")]
	#[doc(alias = "get_web_view")]
	fn web_view(&self) -> Option<WebView> {
		unsafe { from_glib_none(ffi::webkit_download_get_web_view(self.as_ref().to_glib_none().0)) }
	}
	...
	fn connect_failed<F:Fn(&Self, &glib::Error) + 'static>(&self, f:F) -> SignalHandlerId {
		unsafe extern fn failed_trampoline<P:IsA<Download>, F:Fn(&P, &glib::Error) + 'static>(
			this:*mut ffi::WebKitDownload,
	...
	fn connect_finished<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		unsafe extern fn finished_trampoline<P:IsA<Download>, F:Fn(&P) + 'static>(
			this:*mut ffi::WebKitDownload,
			f:glib::ffi::gpointer,
		) {
			let f:&F = &*(f as *const F);
	...
	fn connect_received_data<F:Fn(&Self, u64) + 'static>(&self, f:F) -> SignalHandlerId {
		unsafe extern fn received_data_trampoline<P:IsA<Download>, F:Fn(&P, u64) + 'static>(
			this:*mut ffi::WebKitDownload,
			data_length:u64,
			f:glib::ffi::gpointer,
		) {
	...
	fn connect_allow_overwrite_notify<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		unsafe extern fn notify_allow_overwrite_trampoline<P:IsA<Download>, F:Fn(&P) + 'static>(
			this:*mut ffi::WebKitDownload,
	...
	fn connect_destination_notify<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		unsafe extern fn notify_destination_trampoline<P:IsA<Download>, F:Fn(&P) + 'static>(
			this:*mut ffi::WebKitDownload,
			_param_spec:glib::ffi::gpointer,
			f:glib::ffi::gpointer,
		) {
	...
	fn connect_response_notify<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		unsafe extern fn notify_response_trampoline<P:IsA<Download>, F:Fn(&P) + 'static>(
			this:*mut ffi::WebKitDownload,
			_param_spec:glib::ffi::gpointer,
			f:glib::ffi::gpointer,
		) {
