...
impl MimeInfo {
	...
	pub fn description(&self) -> Option<glib::GString> {
		unsafe {
			from_glib_none(ffi::webkit_mime_info_get_description(
				self.to_glib_none().0,
			))
		}
	}
	...
	pub fn extensions(&self) -> Vec<glib::GString> {
		unsafe {
			FromGlibPtrContainer::from_glib_none(
				ffi::webkit_mime_info_get_extensions(self.to_glib_none().0),
			)
		}
	}
	...
	pub fn mime_type(&self) -> Option<glib::GString> {
		unsafe {
			from_glib_none(ffi::webkit_mime_info_get_mime_type(
				self.to_glib_none().0,
			))
		}
	}
